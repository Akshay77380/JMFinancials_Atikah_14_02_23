...
class SliderButton extends StatefulWidget {
  ...
  /// Enable Shimmer Animation on the text. Defaults to false
  final bool shimmer;

  /// Shimmer base Color. Defaults to black26
  final Color shimmerBase;

  ///Shimmer highlight Color. Defaults to Colors.blueAccent
  ...
  const SliderButton({
    ...
    this.shimmer = false,
    this.shimmerBase = Colors.black26,
    this.shimmerHighlight = Colors.blueAccent,
  }) : assert(height >= 25);
