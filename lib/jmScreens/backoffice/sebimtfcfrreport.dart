...
class SebiMtfCfrReport extends StatefulWidget {
  const SebiMtfCfrReport({Key key}) : super(key: key);

  @override
  State<SebiMtfCfrReport> createState() => _SebiMtfCfrReportState();
}

class _SebiMtfCfrReportState extends State<SebiMtfCfrReport> {
            ...
            Row(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Text('SEBI MTF Report', style: Utils.fonts(size: 14.0, fontWeight: FontWeight.w500, color: Utils.blackColor)),
