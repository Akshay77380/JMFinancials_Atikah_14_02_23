...
class _DerivativeOrderScreenState extends State<DerivativeOrderScreen> {
  ...
  List<String> _productItems = ['NRML', 'MIS'], _orderValidityItems = ['DAY', 'IOC', 'GTC', 'GTD'];
          ...
          if (data['result'] == true) {
            Dataconstants.orderBookData.fetchOrderBook().then((value) {
              return showModalBottomSheet(
                  isScrollControlled: true, context: context, backgroundColor: Colors.transparent, builder: (context) => OrderStatusDetails(OrderBookController.OrderBookList.value.data[0], ));
            });
          }
        }
      } catch (e) {}
