...
List<ReportAlgo> reportAlgoFromJson(String str) =>
    List<ReportAlgo>.from(json.decode(str).map((x) => ReportAlgo.fromJson(x)));

String reportAlgoToJson(List<ReportAlgo> data) =>
...
class ReportAlgo {
  ...
  factory ReportAlgo.fromJson(Map<String, dynamic> json) => ReportAlgo(
      algoId: json["AlgoID"],
