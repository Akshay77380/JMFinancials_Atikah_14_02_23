...
//
//     final reportAlgo = reportAlgoFromJson(jsonString);
import 'dart:convert';
import 'package:markets/model/scrip_info_model.dart';
import 'package:markets/util/CommonFunctions.dart';

List<ReportRunningAlgo> reportRunningAlgoFromJson(String str) =>
    List<ReportRunningAlgo>.from(
        json.decode(str).map((x) => ReportRunningAlgo.fromJson(x)));

String reportRunningAlgoToJson(List<ReportRunningAlgo> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ReportRunningAlgo {
  ReportRunningAlgo({
    this.algoId,
    this.algoName,
    this.instId,
  ...
  factory ReportRunningAlgo.fromJson(Map<String, dynamic> json) =>
      ReportRunningAlgo(
          algoId: json["AlgoID"],
