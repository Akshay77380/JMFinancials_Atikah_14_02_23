...
//
//     final bseDecline = bseDeclineFromJson(jsonString);

import 'dart:convert';

BseDecline bseDeclineFromJson(String str) => BseDecline.fromJson(json.decode(str));

String bseDeclineToJson(BseDecline data) => json.encode(data.toJson());
...
class BseDecline {
  ...
  factory BseDecline.fromJson(Map<String, dynamic> json) => BseDecline(
