...
//
//     final nseDecline = nseDeclineFromJson(jsonString);

import 'dart:convert';

NseDecline nseDeclineFromJson(String str) => NseDecline.fromJson(json.decode(str));

String nseDeclineToJson(NseDecline data) => json.encode(data.toJson());
...
class NseDecline {
  ...
  factory NseDecline.fromJson(Map<String, dynamic> json) => NseDecline(
