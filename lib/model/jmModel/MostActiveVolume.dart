...
//
//     final mostActiveVolume = mostActiveVolumeFromJson(jsonString);

import 'dart:convert';

MostActiveVolume mostActiveVolumeFromJson(String str) => MostActiveVolume.fromJson(json.decode(str));

String mostActiveVolumeToJson(MostActiveVolume data) => json.encode(data.toJson());

class MostActiveVolume {
  MostActiveVolume({
    this.success,
    this.data,
    this.status,
  ...
  factory MostActiveVolume.fromJson(Map<String, dynamic> json) => MostActiveVolume(
