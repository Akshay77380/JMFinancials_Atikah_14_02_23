...
//
//     final fiftyTwoWeekLow = fiftyTwoWeekLowFromJson(jsonString);

import 'dart:convert';

FiftyTwoWeekLow fiftyTwoWeekLowFromJson(String str) => FiftyTwoWeekLow.fromJson(json.decode(str));

String fiftyTwoWeekLowToJson(FiftyTwoWeekLow data) => json.encode(data.toJson());
...
class FiftyTwoWeekLow {
  ...
  factory FiftyTwoWeekLow.fromJson(Map<String, dynamic> json) => FiftyTwoWeekLow(
